    ...
    return (
        ...
        <div class = "grid grid-cols-1" >
            <div class = "web-portfolio-description m-auto">
                ...
                <div class = "ylink-container">  <img src={figma} alt={"figma"} class = {"web-link"} onClick={(e) => {e.preventDefault(); window.open('https://www.figma.com/file/AB0pULHAnsgWMeSAy6qAMl/RESEARCH-WEBSITE-TEMPLATE-%3A-STUDIO-KAIL?node-id=0%3A1');}}/> </div>
               ...
               <p class = "text-indented" > &#8226; Figma file for both the wireframe and coloured version <br/> <br/>
                ...
                Website made using React and Tailwind and utilised predominantly Javascript, HTML and CSS. Logo and icons were made using Adobe Illustrator.        </p>
                </div>
            </div>
            </div>
